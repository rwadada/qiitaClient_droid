...
"resource": {
  ...
  "tags":[{
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript data-gtmsrc=\"https:\/\/cdn.bigmining.com\/private\/js\/qiita_bigmining.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":44
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript async data-gtmsrc=\"https:\/\/www.googletagservices.com\/tag\/js\/gpt.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Evar googletag=googletag||{};googletag.cmd=googletag.cmd||[];\n(function(f,b){b.cmd.push(function(){function m(){var d=document.createElement(\"div\");d.style.marginTop=\"4px\";d.style.textAlign=\"right\";d.style.fontSize=\"0.9em\";var a=document.createElement(\"a\");a.href=\"http:\/\/blog.qiita.com\/post\/176483510744\/community-sponsor\";a.target=\"_blank\";var b=document.createElement(\"i\");b.classList.add(\"fa\");b.classList.add(\"fa-fw\");b.classList.add(\"fa-info-circle\");var e=document.createElement(\"span\");e.textContent=\"ja\"==I18n.locale?\"\\u30b3\\u30df\\u30e5\\u30cb\\u30c6\\u30a3\\u30b9\\u30dd\\u30f3\\u30b5\\u30fc\\u5e83\\u544a\":\n\"Community Sponsor Ads (JA)\";a.appendChild(b);a.appendChild(e);d.appendChild(a);return d}for(var l=[],n=document.querySelectorAll(\".it-Tags_item \\x3e span\"),t=[],v={\"c++\":\"cpp\",\"c#\":\"csharp\"},p,q=0,w=n.length;q\u003Cw;q++)p=n[q].textContent.toLowerCase(),t.push(v[p]||p);b.pubads().setTargeting(\"article_tags\",t);var u=f.querySelector(\".p-items_options\");300\u003C=u.clientWidth\u0026\u0026function(){var d=\"dfp-slot-sidebar-top\",a=300,h=250;b.defineSlot(\"\/383564218\/qiita.com_loginuser_sidebar-top\",[a,h],d).addService(b.pubads());\nl.push(function(){var e=f.createElement(\"div\");e.id=d;e.style.width=a+\"px\";e.style.height=h+\"px\";e.style.marginTop=\"16px\";var c=f.createDocumentFragment();c.appendChild(e);c.appendChild(m());u.appendChild(c);b.display(d)})}();n=f.querySelector(\".it-MdContent\").clientWidth;672\u003C=n?function(){var d=\"dfp-slot-footer\",a=[\"-left\",\"-right\"],h=336,e=280;a.forEach(function(a){b.defineSlot(\"\/383564218\/qiita.com_loginuser_under-article\"+a,[[h,e],[300,250]],d+a).addService(b.pubads())});l.push(function(){var c=\nf.querySelector(\".p-items_main\"),g=f.createElement(\"div\");g.style.textAlign=\"center\";g.style.marginRight=\"-12px\";g.style.marginLeft=\"-12px\";a.forEach(function(b,a){var c=f.createElement(\"div\");c.style.display=\"inline-block\";c.style.marginTop=\"48px\";c.style.verticalAlign=\"top\";0===a\u0026\u0026(c.style.marginRight=\"8px\");var k=f.createElement(\"div\");k.id=d+b;k.style.height=e+\"px\";k.style.width=h+\"px\";g.appendChild(c);c.appendChild(k);1===a\u0026\u0026c.appendChild(m())});c.appendChild(g);a.forEach(function(a){b.display(d+\na)})})}():function(){var d=\"dfp-slot-after-body-for-mobile\",a=300,h=250;b.defineSlot(\"\/383564218\/qiita.com_loginuser_under-article_mobile\",[a,h],d).addService(b.pubads());l.push(function(){var e=f.querySelector(\".p-items_main\"),c=f.createElement(\"div\");c.style.textAlign=\"center\";var g=f.createElement(\"div\");g.style.display=\"inline-block\";g.style.margin=\"48px auto 10px\";var k=f.createElement(\"div\");k.id=d;k.style.height=h+\"px\";k.style.width=a+\"px\";c.appendChild(g);g.appendChild(k);g.appendChild(m());\ne.appendChild(c);b.display(d)})}();var r=f.querySelector(\".footer_inner\");728\u003C=r.clientWidth\u0026\u0026function(){var d=\"dfp-slot-after-body-for-footer\",a=728,h=90;b.defineSlot(\"\/383564218\/qiita.com_loginuser_page-bottom\",[a,h],d).addService(b.pubads());l.push(function(){var e=f.createElement(\"div\");e.style.marginTop=\"8px\";e.style.paddingTop=\"40px\";e.style.borderTop=\"1px solid #eee\";var c=f.createElement(\"div\");c.style.width=a+\"px\";c.style.margin=\"0 auto\";var g=f.createElement(\"div\");g.id=d;g.style.height=\nh+\"px\";g.style.width=a+\"px\";c.appendChild(g);c.appendChild(m());e.appendChild(c);r.insertBefore(e,r.firstChild);b.display(d)})}();b.pubads().enableSingleRequest();b.pubads().collapseEmptyDivs();b.enableServices();setTimeout(function(){l.forEach(function(b){b()})},1E3)})})(document,googletag);\u003C\/script\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":45
...
void 0!==c.vtp_forceSsl&&c.vtp_forceSsl&&(u.push(["_gat._forceSSL"]),v=!!c.vtp_forceSsl);l("_setCustomVar",function(a){for(var b=
[],c=0;a&&c<a.length;c++){var d=a[c];void 0!==d.value&&(d.slot=Ba(d.slot),d.scope=p(Ba,d.scope),b.push(d))}return b}(c.vtp_customVar),["slot","name","value","scope"]);d("_set","hitCallback",function(){sa(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){}else if("TRACK_TIMING"==
